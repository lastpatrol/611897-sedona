...
// Фишка с подстановкой в поля ближайших дат
...
// Фокус и выделение поля (чтобы потом навесить таймаут)
...
// Анимация ошибки при отправке незаполненных полей
